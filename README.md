...
2nd value probably not to be seen since the value is idealy 1. 
Ping is a bad example since after the first Drop the sequence number and sample rate is in slight drift
```
